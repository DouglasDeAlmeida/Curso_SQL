...
class SQLTester:
    ...
    GABARITOS = {
        ...
        6: "SELECT * FROM clientes WHERE cidade <> 'São Paulo';",
    ...
    DICAS = {
        ...
        4:  "Dica: Selecione apenas a coluna `nome` da tabela `clientes`.",
        ...
        6: "Dica: Filtre usando `WHERE cidade <> 'São Paulo'` ou `WHERE cidade != 'São Paulo'`.",
...
if st.session_state["tela_ativa"] == "Playground":
  ...
  (id_cliente)           (id_pedido)           (id_livro)
    ...
    questoes = [
        ...
        (4, "Mostre apenas o nome de todos os clientes da tabela `clientes`:", False),
        (5, "Liste as compras (tabela `pedidos`) realizadas após '2026-02-01':", False),
        (6, "Mostre os clientes que não moram em 'São Paulo':", False),
